...
void printAggregationResults(const map<string, AggregatedValues> &aggregationResults, const vector<string> &columnNames, const set<int> &selectedAggregations, const set<int> &selectedColumns, const string &tableName, const string &finalColumnName, const bool isRollup)
{
    size_t aggColWidth = 10;
        ...
        if (((numOfsc * (numOfsc - 1)) / 2) == sum)
        {
            while (true)
            {
                ...
                if (operationChoice == "R" || operationChoice == "r" || operationChoice == "C" || operationChoice == "c")
                {
                    ...
                    if (isRollUp)
                    {
                        printAggregationResults(rollUpMap, columnNames, selectedAggregations, selectedColumns, tableName, finalColumnName, isRollUp);
                    }
                    else
                    {
                        printAggregationResults(cubeMap, columnNames, selectedAggregations, selectedColumns, tableName, finalColumnName, isRollUp);
                    }
                    break;
                }
                else
